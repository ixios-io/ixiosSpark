...
// Account represents an Ixios account located at a specific location defined
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(bases []DerivationPath, chain ixiosSpark.ChainStateReader)
...
func TextAndHash(data []byte) ([]byte, string) {
	msg := fmt.Sprintf("\x19Ixios Signed Message:\n%d%s", len(data), string(data))
