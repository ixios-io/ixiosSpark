...
//
// The BIP-32 spec https://archive.is/HTnGh
// defines derivation paths to be of the form:
//
//	m / purpose' / coin_type' / account' / change / address_index
//
// The BIP-44 spec https://archive.is/4oI3y
// defines that the `purpose` be 44' (or 0x8000002C) for crypto currencies, and
// SLIP-44 https://archive.is/onnuA assigns
// the `coin_type` 60' (or 0x8000003C)
//
// The root path for Ixios is m/44'/60'/0'/0 according to the specification
// from https://archive.is/HE4rZ, albeit it's not set in stone
