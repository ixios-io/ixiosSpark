...
// Client defines typed wrappers for the Ixios RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) BlockReceipts(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash) ([]*types.Receipt, error) {
	...
	if err == nil && r == nil {
		return nil, ixiosSpark.NotFound
	}
	return r, err
}
...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	...
	if head.OmmerHash == types.EmptyOmmerHash && len(body.OmmerHashes) > 0 {
	...
	if len(body.OmmerHashes) > 0 {
		uncles = make([]*types.Header, len(body.OmmerHashes))
		reqs := make([]rpc.BatchElem, len(body.OmmerHashes))
		for i := range reqs {
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, ixiosSpark.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*ixiosSpark.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (ixiosSpark.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q ixiosSpark.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q ixiosSpark.FilterQuery, ch chan<- types.Log) (ixiosSpark.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q ixiosSpark.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg ixiosSpark.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg ixiosSpark.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg ixiosSpark.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*ixiosSpark.FeeHistory, error) {
...
// the true gas limit requirement as other transactions may be added or removed by sealers,
// but it should provide a basis for setting a reasonable default.
func (ec *Client) EstimateGas(ctx context.Context, msg ixiosSpark.CallMsg) (uint64, error) {
...
func toCallArg(msg ixiosSpark.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *ixiosSpark.SyncProgress {
	if p == nil {
		return nil
	}
