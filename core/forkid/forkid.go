...
// Package forkid implements EIP-2124 (https://archive.is/Cj4cc).
package forkid
...
// timestampThreshold is the mainnet genesis timestamp. It is used to
...
const timestampThreshold = 1735718400
...
// NewID calculates the Ixios fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Ixios fork ID from an existing chain instance.
