...
func ReadAccountTrieNode(db kvdb.KeyValueReader, path []byte) ([]byte, common.Hash) {
...
func HasAccountTrieNode(db kvdb.KeyValueReader, path []byte, hash common.Hash) bool {
	data, err := db.Get(accountTrieNodeKey(path))
	if err != nil {
		return false
	}
...
func ExistsAccountTrieNode(db kvdb.KeyValueReader, path []byte) bool {
...
func WriteAccountTrieNode(db kvdb.KeyValueWriter, path []byte, node []byte) {
...
func DeleteAccountTrieNode(db kvdb.KeyValueWriter, path []byte) {
...
// hash with the specified node path.
func ReadStorageTrieNode(db kvdb.KeyValueReader, accountHash common.Hash, path []byte) ([]byte, common.Hash) {
...
// node path and the associated node hash.
func HasStorageTrieNode(db kvdb.KeyValueReader, accountHash common.Hash, path []byte, hash common.Hash) bool {
	data, err := db.Get(storageTrieNodeKey(accountHash, path))
	if err != nil {
		return false
	}
...
func ExistsStorageTrieNode(db kvdb.KeyValueReader, accountHash common.Hash, path []byte) bool {
...
func WriteStorageTrieNode(db kvdb.KeyValueWriter, accountHash common.Hash, path []byte, node []byte) {
...
func DeleteStorageTrieNode(db kvdb.KeyValueWriter, accountHash common.Hash, path []byte) {
...
func ReadLegacyTrieNode(db kvdb.KeyValueReader, hash common.Hash) []byte {
...
func HasLegacyTrieNode(db kvdb.KeyValueReader, hash common.Hash) bool {
	ok, _ := db.Has(hash.Bytes())
	return ok
}

// WriteLegacyTrieNode writes the provided legacy trie node to database.
func WriteLegacyTrieNode(db kvdb.KeyValueWriter, hash common.Hash, node []byte) {
...
func DeleteLegacyTrieNode(db kvdb.KeyValueWriter, hash common.Hash) {
...
func HasTrieNode(db kvdb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) bool {
	switch scheme {
	case HashScheme:
...
//   - owner
//   - path
func ReadTrieNode(db kvdb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) []byte {
	switch scheme {
	case HashScheme:
...
//   - owner
//   - path
func WriteTrieNode(db kvdb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, node []byte, scheme string) {
	switch scheme {
	case HashScheme:
...
//   - owner
//   - path
func DeleteTrieNode(db kvdb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, scheme string) {
	switch scheme {
	case HashScheme:
...
func ReadStateScheme(db kvdb.Reader) string {
...
//     compatible with persistent state scheme.
func ParseStateScheme(provided string, disk kvdb.Database) (string, error) {
