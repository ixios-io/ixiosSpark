...
import (
	...
	"github.com/ixios-io/ixiosSpark/kvdb/leveldb"
	"github.com/ixios-io/ixiosSpark/kvdb/memorydb"
	"github.com/ixios-io/ixiosSpark/kvdb/pebble"
...
func (db *nofreezedb) ModifyAncients(func(kvdb.AncientWriteOp) error) (int64, error) {
	return 0, errNotSupported
}
...
func (db *nofreezedb) ReadAncients(fn func(reader kvdb.AncientReaderOp) error) (err error) {
...
func NewDatabase(db kvdb.KeyValueStore) kvdb.Database {
...
func NewDatabaseWithFreezer(db kvdb.KeyValueStore, ancient string, namespace string, readonly bool) (kvdb.Database, error) {
...
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (kvdb.Database, error) {
...
// moving immutable chain segments into cold storage.
func NewPebbleDBDatabase(file string, cache int, handles int, namespace string, readonly, ephemeral bool) (kvdb.Database, error) {
...
func openKeyValueDatabase(o OpenOptions) (kvdb.Database, error) {
...
func Open(o OpenOptions) (kvdb.Database, error) {
...
func InspectDatabase(db kvdb.Database, keyPrefix, keyStart []byte) error {
...
func printChainMetadata(db kvdb.KeyValueStore) {
...
func ReadChainMetadata(db kvdb.KeyValueStore) [][]string {
