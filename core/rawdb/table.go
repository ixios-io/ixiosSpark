...
func NewTable(db kvdb.Database, prefix string) kvdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(kvdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader kvdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) kvdb.Iterator {
...
func (t *table) NewBatchWithSize(size int) kvdb.Batch {
...
func (t *table) NewSnapshot() (kvdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w kvdb.KeyValueWriter) error {
