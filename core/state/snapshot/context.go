...
type generatorContext struct {
	...
	db      kvdb.KeyValueStore // Key-value store containing the snapshot data
...
func newGeneratorContext(stats *generatorStats, db kvdb.KeyValueStore, accMarker []byte, storageMarker []byte) *generatorContext {
