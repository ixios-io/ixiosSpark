...
func loadAndParseJournal(db kvdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb kvdb.KeyValueStore, triedb *triedb.Database, root common.Hash, cache int, recovery bool, noBuild bool) (snapshot, bool, error) {
...
func iterateJournal(db kvdb.KeyValueReader, callback journalCallback) error {
