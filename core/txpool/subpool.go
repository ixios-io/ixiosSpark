...
// enough for the sealer and other APIs to handle large batches of transactions;
...
type LazyTransaction struct {
	...
	GasTipCap *uint256.Int // Maximum sealer tip per gas the transaction can pay
...
type PendingFilter struct {
	MinTip  *uint256.Int // Minimum sealer tip required to include a transaction
