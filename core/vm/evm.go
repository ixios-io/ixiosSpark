...
var (
	ContractDeployerAddress = common.HexToAddress("00000000000024d6edcb7b81a783c429879d36d0c90c6dd05260e4485cc0aeae")
)
...
// EVM is the Ixios Virtual Machine base object and provides
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *uint256.Int, address common.Address, typ OpCode) ([]byte, common.Address, uint64, error) {
	// Check for authorized deployer
	if caller.Address() != ContractDeployerAddress {
