...
type SyncProgress struct {
	...
	// "fast sync" fields. These used to be sent by ixiosSpark, but are no longer used
	// since version v1.10.
...
// true gas limit requirement as other transactions may be added or removed by sealers, but
