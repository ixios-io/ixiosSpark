...
// Package web3ext contains ixiosSpark specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: 'eth_resend',
			params: 3,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter, web3._extend.fromDecimal, web3._extend.fromDecimal]
		}),
		new web3._extend.Method({
		...
		new web3._extend.Method({
			...
			outputFormatter: web3._extend.toDecimal
		}),
		new web3._extend.Method({
		...
		new web3._extend.Method({
			...
			call: function(args) {
				return (web3._extend.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'eth_getRawTransactionByBlockHashAndIndex' : 'eth_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter, web3._extend.toHex]
		}),
		new web3._extend.Method({
			name: 'getProof',
			call: 'eth_getProof',
	...
	properties: [
		...
		new web3._extend.Property({
			...
			outputFormatter: web3._extend.toBigNumber
		}),
	]
});
`
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'setEtherbase',
			call: 'sealer_setEtherbase',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter]
		}),
		new web3._extend.Method({
			name: 'setExtra',
			call: 'sealer_setExtra',
			params: 1
		}),
		new web3._extend.Method({
			name: 'setGasPrice',
			call: 'sealer_setGasPrice',
			params: 1,
			inputFormatter: [web3._extend.fromDecimal]
		}),
		new web3._extend.Method({
			name: 'setGasLimit',
			call: 'sealer_setGasLimit',
			params: 1,
			inputFormatter: [web3._extend.fromDecimal]
		}),
		new web3._extend.Method({
			name: 'setRecommitInterval',
			call: 'sealer_setRecommitInterval',
			params: 1,
		}),
		new web3._extend.Method({
			name: 'getHashrate',
			call: 'sealer_getHashrate'
		}),
	],
	properties: []
});
	...
	[
		...
		new web3._extend.Property({
			...
			outputFormatter: function(status) {
				status.pending = web3._extend.toDecimal(status.pending);
				status.queued = web3._extend.toDecimal(status.queued);
				return status;
			}
		}),
		new web3._extend.Method({
