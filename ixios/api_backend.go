...
func (b *EthAPIBackend) HeaderByNumber(ctx context.Context, number rpc.BlockNumber) (*types.Header, error) {
	// Pending block is only known by the sealer
	if number == rpc.PendingBlockNumber {
		block := b.eth.sealer.PendingBlock()
		if block == nil {
...
func (b *EthAPIBackend) PendingBlockAndReceipts() (*types.Block, types.Receipts) {
	return b.eth.sealer.PendingBlockAndReceipts()
}

func (b *EthAPIBackend) StateAndHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (*state.StateDB, *types.Header, error) {
	// Pending state is only known by the sealer
	if number == rpc.PendingBlockNumber {
		block, state := b.eth.sealer.Pending()
...
func (b *EthAPIBackend) SubscribePendingLogsEvent(ch chan<- []*types.Log) event.Subscription {
	return b.eth.sealer.SubscribePendingLogs(ch)
}
...
func (b *EthAPIBackend) SyncProgress() ixiosSpark.SyncProgress {
...
func (b *EthAPIBackend) ChainDb() kvdb.Database {
...
func (b *EthAPIBackend) Miner() *sealer.Sealer {
	return b.eth.Miner()
}
