...
func (api *DownloaderAPI) eventLoop() {
	var (
		...
		getProgress = func() ixiosSpark.SyncProgress {
			prog := api.d.Progress()
...
// Syncing provides information when this nodes starts synchronising with the Ixios network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ixiosSpark.SyncProgress `json:"status"`
}
