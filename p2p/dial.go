...
const (
	...
	// private networks.
	dialHistoryExpiration = 500 * time.Millisecond
...
func (d *dialScheduler) logStats() {
	d.log.Trace("Dialer Stats", "maxDialPeers", d.maxDialPeers, "peercount", len(d.peers), "tried", d.doneSinceLastLog, "static", len(d.static))
	now := d.clock.Now()
