...
func NewNodeStateMachine(db kvdb.KeyValueStore, dbKey []byte, clock mclock.Clock, setup *Setup) *NodeStateMachine {
	if setup.flags == nil {
...
func (ns *NodeStateMachine) AddLogMetrics(requireFlags, disableFlags Flags, name string) {
	var count int64
