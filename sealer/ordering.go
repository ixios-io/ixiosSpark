...
// txWithMinerFee wraps a transaction with its gas price or effective sealer gasTipCap
...
// sealer gasTipCap if a base fee is provided.
// Returns error in case of a negative effective sealer gasTipCap.
