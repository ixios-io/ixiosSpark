...
func truncateFromHead(db kvdb.Batcher, freezer *rawdb.ResettableFreezer, nhead uint64) (int, error) {
...
func truncateFromTail(db kvdb.Batcher, freezer *rawdb.ResettableFreezer, ntail uint64) (int, error) {
	ohead, err := freezer.Ancients()
	if err != nil {
		return 0, err
	}
